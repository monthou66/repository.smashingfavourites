...
#        if xbmcgui.Dialog().yesno("Backup Xonfluence now?"):
            ...
            if not yesnowindow:
                ...
                produce.close()
                FOLDER = os.path.join(xbmc.translatePath('special://masterprofile/'), "smashingfavourites/backups/skins/xonfluence/%s" % OPTION)
...
# option to redo backup or make new one
            ...
            if yesnowindow:
                SAVEDSETTINGS = os.path.join(xbmc.translatePath('special://masterprofile/'), "smashingfavourites/backups/skins/xonfluence", OPTION, "settings.xml")
                FOLDER = os.path.join(xbmc.translatePath('special://masterprofile/'), "smashingfavourites/backups/skins/xonfluence/%s" % OPTION)
