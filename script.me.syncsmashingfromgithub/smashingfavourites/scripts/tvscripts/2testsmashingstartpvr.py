...
##              pvraddon, choose
##              choose
##              disable / cleardb / reset / multiple / singular / permanent / temp / getsettings - any of these sets a 'housekeeping' flag
##              options
##  
##              don't mix 1 and 2
##  
...
#    global pvraddon, window, channels, guide, disable, refresh, cleardb, reset, permanent, temp, group, data, force, quiet, groupnumber, error, error2
    global pvraddon, window, disable, refresh, cleardb, reset, permanent, group, data, multiple, force, quiet, groupnumber, error, error2, arglist, housekeeping, switcheroo
