...
##  
##
##  history is stored in kodi/userdata/smashing/smashingfavourites/tempfiles/dialoghistory.txt
######################################################################################################################################################
######################################################################################################################################################
...
history = os.path.join(USERDATA, "smashing", "smashingfavourites", "tempfiles", "dialoghistory.txt")
